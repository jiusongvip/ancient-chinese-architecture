...
export const buildings: Building[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Cave Architecture Forms', body: "Longmen's caves take three principal architectural forms: the niche (a simple carved alcove holding a single figure), the chamber cave (a rectangular or horseshoe-shaped room entered through a doorway), and the monumental open-air temple cut directly into the cliff face. Many caves preserve carved details that imitate timber construction — stone lintels, brackets, and roof beams — showing that stone-cutters worked from wooden temple prototypes.\n\nThe site also preserves architectural history in miniature: relief carvings of pavilions, pagodas, and towers in the cave walls provide some of the best surviving depictions of Tang and Northern Wei buildings, many of which no longer exist. The Binyang Central Cave, begun in 505 CE, preserves a full carved facade with arched doorway and roof ridge in stone — a complete elevation of a 6th-century Buddhist hall." }
    ],
