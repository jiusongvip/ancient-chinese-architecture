...
export const elements: Element[] = [
  ...
  },
  {
    ...
    description: 'The roof is the most legally regulated element of Chinese architecture. Five principal forms — hip, hip-and-gable, overhanging gable, flush gable, and pyramidal — were ranked by statute, and using a form above your rank was a punishable offense. The sweeping curves shed rain in long arcs, the upturned eaves lighten the massive silhouette, and the number of ridge beasts marching along the eave announced the owner\'s status: ten on the Hall of Supreme Harmony, seven on lesser imperial halls, none at all on commoner houses. The roof is where Chinese architecture announces its hierarchy to anyone who can read it.',
    sections: [
  ...
  },
  {
    ...
    description: 'The courtyard — whether the humble siheyuan of Beijing or the vast walled compounds of the Forbidden City — is the fundamental organizing principle of Chinese architecture. A commoner family was legally limited to one courtyard with a 3-bay main hall; the emperor\'s palace contains roughly 90. The south-facing main hall is passive solar engineering: it admits low winter sun while the building mass blocks the cold north wind, a principle recorded in the Book of Changes 3,000 years ago. Courtyard layouts encode social hierarchy in the ground plan itself.',
    sections: [
  ...
  },
  {
    ...
    description: 'Chinese architectural decoration is a legally enforced language of rank. The ridge beasts marching along the roof are talismans that also pin down heavy glazed ridge-caps against wind; the painted beams (caihua) seal timber against moisture while announcing the building\'s status in three grades — dragon-and-phoenix for imperial halls, spiral scrolls for temples, landscapes for gardens. Color was regulated by law: yellow for the emperor alone, blue for heaven, green for princes, red for vitality at gates and columns. Every pattern, figure, and hue carries meaning.',
    sections: [
